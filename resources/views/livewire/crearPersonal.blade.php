  ...
  <div class="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
    <div class="modal-content py-4 pb-1 text-left px-6">
      ...
      <div class="flex justify-between items-center pb-3">
        <p class="text-2xl font-bold text-gray-500">Datos del Personal</p>
      </div>
      <!--Body-->
      <div class="my-5 mr-5 ml-5 flex justify-center">
        <form method="POST" id=""  class="w-full">
          <div class="">
            ...
            <div class="">
              <input type="text" id="direccion" wire:model="direccion" autocomplete="off" name="direccion" class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md" placeholder="Ejemplo. Calle Santa Cruz esq Camperos">
            </div>

            <!--Tipo--> 
            <div class="">
              <label for="tipo" class="text-md text-gray-600">Tipo Personal</label>
            </div>
            <div class="block text-left">
              <select wire:model="tipo" class="w-full p-3 text-base border-gray-300 placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
            ...
            <div class="block text-left">
              <select wire:model="turno" class="w-full p-3 text-base border-gray-300 placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline">
