        ...
        <div class="my-5 mr-5 ml-5 flex justify-center">
                    <form method="POST" id=""  class="w-full">
                        <div class="">
                          ...
                          <div class="">
                            <input type="text" id="turno" wire:model="turno" autocomplete="off" name="turno" class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md" placeholder="Ejemplo. Medio día">
                          </div>
                        </div>
